...
class FoodCategorizer:
    ...
    # This sorts food items by expiration date to be used in the summary display
...
class App_EnterFood:
    ...
    def on_enter(self):
        ...
        try:
            # This turns the date string into a datetime format that can be compared
...
class App_RemoveFood:
    def __init__(self, root, expired, exp_today, exp_soon, others, refresh_callback=None):
        ...
        for item in self.all_items:
            # This formats the display as "food | expiry_date"
    ...
    # This removes the selected item from the database and GUI
